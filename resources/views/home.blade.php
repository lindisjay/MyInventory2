        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <center><h1 style="font-family:Roboto;"><strong >Selamat Datang di Sistem Inventaris </strong></h1></center>
                    <br><center><h3 style="font-family:Roboto">  Batik Shop Ambar</h3></center>
                </div>
                <div class="panel-body">
                @if(Auth::user()->jabatan == 'ADMIN')
                    <div class="panel-body" align="center">
                        <center><img src="images/stok.jpg" alt="" width="500px" height="500px"></center>
                        <!--<div>
                ...
                @else
                    <div class="panel-body">
                        <center><img src="images/ambar.jpg" alt="" width="500px" height="500px"></center>
                    </div>
                @endif  
                </div>
            </div>
